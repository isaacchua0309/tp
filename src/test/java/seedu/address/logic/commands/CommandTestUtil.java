...
public class CommandTestUtil {
    ...
    public static final String VALID_SPORTS_CRICKET = "cricket";
    public static final String VALID_SPORTS_BADMINTON = "badminton";
    ...
    public static final String SPORTS_DESC_CRICKET = " " + PREFIX_SPORT + VALID_SPORTS_CRICKET;
    ...
    static {
        ...
        DESC_BOB = new EditPersonDescriptorBuilder().withName(VALID_NAME_BOB)
                ...
                .withSports(VALID_SPORTS_BADMINTON, VALID_SPORTS_CRICKET).build();
    }
