...
public class AddressBookParserTest {
    ...
    public void parseCommand_addSport() throws Exception {
        ...
        AddSportCommand command = (AddSportCommand) parser.parseCommand(
                AddSportCommand.COMMAND_WORD + " " + INDEX_FIRST_PERSON.getOneBased() + " s/" + sportName);
        assertEquals(new AddSportCommand(INDEX_FIRST_PERSON.getZeroBased(), new Sport(sportName)), command);
    }
