...
public class AddressBookParserTest {
    ...
    public void parseCommand_edit() throws Exception {
        Person person = new PersonBuilder().build();
        EditPersonDescriptor descriptor = new EditPersonDescriptorBuilder(person).removeSports().build();
    ...
    public void parseCommand_help() throws Exception {
        ...
        // Verify different variations of the help command
        assertTrue(parser.parseCommand("help") instanceof HelpCommand);
        assertTrue(parser.parseCommand("help me please") instanceof HelpCommand);
    }
    ...
    public void parseCommand_addSport() throws Exception {
        ...
        AddSportCommand command = (AddSportCommand) parser.parseCommand(
                AddSportCommand.COMMAND_WORD + " " + INDEX_FIRST_OBJECT.getOneBased() + " s/soccer");
        assertEquals(new AddSportCommand(INDEX_FIRST_OBJECT.getZeroBased(), sport), command);
    }
